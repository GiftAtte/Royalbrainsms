                ...
                <table class="table table-hover">
                  ...
                  <tr v-for="pkey in payStack" :key="pkey.id">
                    ...
                    <td>
                        ...
                        /
                        <a href="#" @click="deleteMessageApi(pkey.id)">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
       ...
       <form @submit.prevent="editmode ? updateMessageApi() : createMessageApi()">
      <div class="modal-body">
                   <div class="form-group">
                <input type="email" name="email" placeholder="Ebulksms Email" id="paystack_key"
                   class="form-control" :class="{ 'is-invalid': form.errors.has('bank') }"
                   v-model="form.email" >
                <has-error :form="email" field="bank"></has-error>
                 </div>
                <div class="form-group">
                <input type="text" name="name" placeholder="Enter ebulksms key" id="api_key"
                ...
                <has-error :form="form" field="api_key"></has-error>
                 ...
                 <div class="form-group">
                     <label>Status</label>
          <select v-model="form.is_active" class="form-control" name="is_active">
                ...
                swal.fire({
                    ...
                    confirmButtonText: 'Yes, delete it!'
                        ...
                        // Send request to the server
                         if (result.value) {
                                this.form.delete('/api/messageApi/'+id).
                                then(()=>{
                                        swal.fire(
                                        'Deleted!',
