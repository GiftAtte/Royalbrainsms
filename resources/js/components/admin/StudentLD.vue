                ...
                <form @submit.prevent="createAssessment">
                    <div class="card-header">
                        <div class="ribbon-wrapper">
                            <div class="ribbon bg-primary">Admin</div>
                        </div>
                    </div>
                    ...
                    <div class="card-body" v-if="$gate.isTutorOrAdmin()">
                        <div class="form-group col-12">
                            <select
                                ...
                                id="report_id"
                                :class="{
                                    'is-invalid': form.errors.has('report_id'),
                                }"
                                class="form-control"
                        ...
                        <div v-show="isResults" class="card-body">
                            <div class="container">
                                <button
                                    v-show="isEntered"
                                    @click="removeAssesment"
                                    type="button"
                                    class="btn btn-flat btn-danger float-right"
                                >
                                    Assessment Already Entered. Click To Remove
                                </button>
                            </div>
                                    ...
                                    >
                                        ...
                                        <td>
                                            ...
                                            >
                                                ...
                                                <label :for="`grade1${index}`"
                                                    >A</label
                                                >
                                            </div>
                                            <div
                                                class="icheck-success icheck-inline pl-2"
                                            >
                                                <input
                                                    type="radio"
                                                    :id="`grade2${index}`"
                                            ...
                                            >
                                                <input
                                                    ...
                                                    "
                                                />
                                                <label :for="`grade3${index}`"
                                                    >C</label
                                                >
                                            </div>
                                            <div
                                                class="icheck-warning icheck-inline"
                                            >
                                                <input
                                                    type="radio"
                                                    :id="`grade4${index}`"
                                                    ...
                                                    "
                                                />
                                                <label :for="`grade4${index}`"
                                                    >D</label
                                                >
                                            </div>
                                            <div
                                                class="icheck-danger icheck-inline"
                                            >
                                                <input
                                                    type="radio"
                                                    :id="`grade5${index}`"
...
export default {
    ...
    methods: {
        loadAssessment() {
            ...
            axios
                .get(
                    `/api/load_assessment/${this.form.arm_id}/${this.form.report_id}/${this.form.learning_domain_id}`
                )
                .then((result) => {
                    ...
                    this.form
                        ...
                        .catch((err) => {
                            toast.fire({
                                type: "danger",
                                title:
                                    "there was error uploading the file" + err,
                            });
                        });
                }
            }
        ...
        removeAssesment() {
            this.form.post("/api/delete_ssessment").then((res) => {
                toast.fire({
                    type: "success",
        ...
        loadDomain() {
            axios.get("api/get_domain").then((res) => {
