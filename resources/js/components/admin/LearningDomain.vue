        ...
        >
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form
                        @submit.prevent="
                            editmode ? updateLDomain() : createLDomain()
                        "
                    >
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                ...
                                <input
                                    ...
                                    class="form-control"
                                    :class="{
                                        'is-invalid': form.errors.has('domain'),
                                    }"
                                    v-model="form.domain"
                                />
                                <has-error
...
export default {
    ...
    methods: {
        getResults(page = 1) {
            axios.get("api/learning_domain?page=" + page).then((response) => {
        ...
        loadLDomain() {
            if (this.$gate.isAdminOrTutor()) {
                axios
                    .get("api/learning_domain")
                    .then((res) => (this.domains = res.data));
            }
        },
