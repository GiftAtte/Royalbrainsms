...
<div class="content-header">
      ...
      <div class="container-fluid navy" >
        <div class="row mb-2">
          <div class="col-sm-6">
            <h2 class="m-0 text-dark">Principal Comments</h2>
          </div><!-- /.col -->
          <div class="col-sm-6">
...
number_of_students:0
        ...
        methods:{
         ...
         this.form.post(`/api/load_principal_comments`)
          .then((result) => {
...
setFile () {
         ...
         for (let index = 0; index < this.Scores.length; index++) {
           ...
           var comment_id=document.querySelector(`#comment_id${index}`).value
           //var comment_id=e.selectElement.options[e.selectedIndex].value
            ...
            this.form.post('/api/principal_comment')
