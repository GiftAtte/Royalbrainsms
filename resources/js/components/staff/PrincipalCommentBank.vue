...
<div class="content-header">
      ...
      <div class="container-fluid navy" >
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Principal Comment </h1>
          </div><!-- /.col -->
          <div class="col-sm-6">

            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Principal comment</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
...
<script>
    ...
    export default {
        ...
        methods: {
            getResults(page = 1) {
                        axios.get('api/principalComments?page=' + page)
                            .then(response => {
            ...
            updateComment(){
                ...
                this.form.put('api/principalComments/'+this.form.id)
                .then(() => {
                    // success
                    $('#addNew').modal('hide');
                     swal.fire(
            ...
            createComment(){
                 this.$Progress.start();
                this.form.post('api/principalComments')
                .then(()=>{
                    Fire.$emit('AfterCreate');
                    $('#addNew').modal('hide')
                ...
                swal.fire({
                    ...
                    confirmButtonText: 'Yes, delete it!'
                        ...
                        // Send request to the server
                         if (result.value) {
                                this.form.delete('api/principalComments/'+id).
                                then(()=>{
                                        swal.fire(
                                        'Deleted!',
         ...
         loadComment(){
                ...
                if(this.$gate.isAdmin()){
                    axios.get("api/principalComments").then(res  => this.comments = res.data);
                }
