...
<div class="col-md-6">
    <h4>{{title}}</h4>
         ...
         <div v-show="is_submited" class="mt-5">
             ...
             <h4 v-if="form.is_graded===1">Score: &nbsp; {{form.score}}%</h4>
             <h4 v-if="form.is_graded===0">Score: Not graded</h4>
        ...
        methods: {
            getAssignment(page = 1) {
                     ...
                     getNote(assignment){
                       ...
                       axios.get('/api/student_assignment/'+assignment.id)
                       .then(res=>{
