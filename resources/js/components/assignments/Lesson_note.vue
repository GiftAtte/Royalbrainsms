                            ...
                            <tbody>
                                ...
                                >
                                    ...
                                    <td class="row">
                                        ...
                                        <a
                                            href="#"
                                            @click="deleteLesson(assignment.id)"
                                            class="pl-2"
                                            v-show="$gate.isAdminOrTutor()"
                                            title="delete"
                                        >
        ...
        >
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <form
                        @submit.prevent="
                            editmode ? updateLesson() : createLesson()
                        "
...
export default {
    ...
    methods: {
        getResult(page = 1) {
            axios.get("/api/getLesson?page=" + page).then((response) => {
        ...
        createLesson() {
            ...
            axios
                .post("/api/create_lesson", formData)
                .then((res) => {
                    $("#addNew").modal("hide");
                    toast.fire({
                        type: "success",
        ...
        loadLesson() {
            axios.get("/api/getLesson").then((res) => {
        ...
        downloadFile(id) {
            axios
                .get("/api/lesson/" + id, { responseType: "arraybuffer" })
                .then((response) => {
