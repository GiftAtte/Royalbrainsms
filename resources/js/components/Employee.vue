                    ...
                    <table class="table table-hover">
                        <tbody>
                            ...
                            >
                                <td>{{ employee.id }}</td>
                                <td>
                                    {{ employee.surname | upText }}, &nbsp;{{
                                        employee.first_name | upText
                                    }}
                                </td>
                                <td>
                                    {{
                                ...
                                <td class="action">
                                    <router-link
                                        :to="`staff_profile/${employee.id}/staff`"
                                        tag="a"
                                        exact
                                ...
                                <td>
                                    <toggle-button
                                        @change="setActivation(employee.userId)"
                                        :label="true"
                                        :labels="{
                                            checked: 'ON',
                                            unchecked: 'OFF',
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                ...
                                >
                                    ...
                                    <option value="tutor">Class Teacher</option>
                            ...
                            <div>
                                <router-link
                                    ...
                                    tag="a"
                                    exact
                                    >Edit email or password</router-link
                                >
                            </div>
                        </div>
...
export default {
    ...
    methods: {
        ...
        importEmployees() {
            ...
            axios
                .post("api/importEmployees", formData)
                .then((res) => {
                    toast.fire({
                        type: "success",
