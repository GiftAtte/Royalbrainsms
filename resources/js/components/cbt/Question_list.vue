            ...
            <div class="card card-navy card-outline">
                <div class="card-bod">
                    ...
                    >
                        <center>
                            <timer
                                :autoSubmit="submitCBT"
                                :duration="duration"
                            />
                        </center>

                        <tab-content
                            title="Exam Details And Instruction"
                            icon="fas fa-book-open"
                        >
                            <ul
                                class="list-group list-group-unbordered mb-3 mt-5"
                            >
                                <li class="list-group-item">
                                    <b>Title:</b>
                                    <a class="pl-5"> &nbsp;{{ exam.title }}</a>
                                </li>
                                <li class="list-group-item">
                                    <b>Level:</b>
                                    <a class="pl-5">
                                        &nbsp;{{ exam.level.level_name }}</a
                                    >
                                </li>
                                <li class="list-group-item">
                                    <b>subject:</b>
                                ...
                                <li class="list-group-item">
                                    <b>Time:</b>
                                    <a class="pl-5"> &nbsp;{{ start_time }}</a>
                                </li>
                                <li class="list-group-item">
                                    <b>Venue:</b>
                                    <a class="pl-5"> &nbsp;{{ exam.venue }}</a>
                                </li>
                                <li class="list-group-item">
                                    <b>Duration:</b>
                                    <a class="pl-4">
                            ...
                            <h3 class="text-success mt-5 text-center">
                                Click the next button to start Test/Exam
                            </h3>
                        </tab-content>
                        ...
                        >
                            <div class="container mt-5" v-show="isSuccess">
                                <h3 class="text-danger text-center">
                                    Thanks! You have Submitted this test, You
                                    can't access the questions again
                                </h3>
                            </div>
                            <div class="container" v-show="!isSuccess">
                                ...
                                >
                                    ...
                                    >
                                        <div
                                            class="icheck-success icheck-inline"
                                        >
                                            <input
                                                type="radio"
                                                :id="`q${options.id}`"
                        ...
                        <tab-content
                            title="Examiner Message"
                            icon="fas fa-graduation-cap"
                        >
                            <h4 class="text-center mt-5">
                                Thank you for participating in this test.<br />
                                Wishing you a succeful outcome!!!
                            </h4>
                            <h3 class="text-success mt-5 text-center">
                                Click the next button to see your Scores
                            </h3>
                        </tab-content>
                        <tab-content title="Test Results" icon="fas fa-check">
                            <h1
                                v-show="score >= 50"
                                class="text-center text-success"
                            >
                                Waooo !!! You have Scored {{ score }}%
                            </h1>
                            <h1
                                v-show="score < 50"
                                class="text-center text-danger"
                            >
                                Sorry! You have Scored {{ score }}%
                            </h1>
                        </tab-content>
                    </form-wizard>
                </div>
    ...
    methods: {
        ...
        loadQuestions() {
            if (this.$gate.isAdminOrTutorOrStudent()) {
                axios.get("/api/cbt/" + this.$route.params.id).then((res) => {
                    this.questions = res.data.cbt;
                    this.exam = res.data.exam;
                    this.score = res.data.score;
                    this.duration = res.data.exam.duration;
                    this.start_date = moment(this.exam.start_date).format(
                        "YYYY-MM-DD"
                    );
                    this.start_time = moment(this.exam.start_date).format(
                        "h:mm a"
                    );
