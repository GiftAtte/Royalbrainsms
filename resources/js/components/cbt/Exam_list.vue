...
<div class="content-header">
      ...
      <div class="container-fluid navy" >
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Examination Scheduling List</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
              ...
              <div class="card-body table-responsive ">
                <table class="table table-hover">
                  ...
                  <tr v-for="exam in exams.data" :key="exam.id">
                    ...
                    <td>{{exam.examiner?exam.examiner.surname:''}}&nbsp; {{exam.examiner?exam.examiner.first_name:''}}</td>
                    ...
                    <td class="row">
                        ...
                        /
                        <a href="#" @click="deleteExam(exam.id) " class="pl-2">
                            <i class="fa fa-trash red"></i>
                        </a>
                        <router-link :to="`/questions/${exam.id}`" tag="a" class="pl-2">
                        Add Questions
                        </router-link>
