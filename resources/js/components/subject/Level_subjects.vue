            ...
            <div class="card card-navy card-outline">
                <div class="card-header">
                    <div class="col-md-12 row">
                        <div v-show="$gate.isAdminOrTutor()" class="col-md-4">
                            <select
                                name="subject_id"
                                id="subject_id"
                                :class="{
                                    'is-invalid': form.errors.has('level_id'),
                                }"
                                class="form-control"
                        ...
                        <div class="col-md-4" v-show="addToList">
                            <select
                                class="form-control"
                                v-model="form.type"
                                name="type"
                            >
                                <option value selected>
                                    Select Class Of Subject
                                </option>
                                <option value=" None Academic">
                                    None Academic Subjects
                                </option>
                    ...
                    <table class="table table-hover">
                        <tbody>
                            ...
                            >
                                ...
                                <td>
                                    {{
                                        subject.type ? subject.type : "Academic"
                                    }}
                                </td>
                                ...
                                <td>
                                    <a
                                        href="#"
                                        @click="deleteSubject_list(subject.id)"
                                        class="pl-2"
                                    >
        ...
        >
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form
                        @submit.prevent="
                            editmode ? updateSubject() : cloneSubjects()
                        "
                    >
                        <div class="modal-body">
                            <div class="form-group">
                                ...
                                <select
                                    ...
                                    :class="{
                                        'is-invalid':
                                            form.errors.has('from_id'),
                                    }"
                                    class="form-control"
                                    v-model="form.from"
                                >
                                    <option value selected>
                                        Select Level to clone from
                                    </option>
                                    <option
                                        v-for="level in levels"
                                        :key="level.id"
...
export default {
    ...
    methods: {
        ...
        cloneSubjects() {
            ...
            console.log([from, to]);
            axios
                .post(`/api/cloneSubjects/${from}/${to}`)
                .then((res) => {
                    $("#addNew").modal("hide");
                    toast.fire({
                        type: "success",
