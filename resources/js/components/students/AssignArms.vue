    ...
    <div>
        <div class="content-header">
            <div class="container-fluid navy">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark">Assign Arms</h1>
                    </div>
                    <!-- /.col -->
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">Assign Arms</li>
                        </ol>
                    </div>
                    <!-- /.col -->
                </div>
        ...
        <div class="card card-outline card-navy">
            <div class="card-body">
                ...
                <div class="table-responsive">
                    <div class="row card-header mt-2 bg-primary">
                        <div class="col-md-6 col-sm-6 text-center">
                            <h3 class="text-uppercase">Current Student</h3>
                        </div>
                        <div class="col-md-6 col-sm-6 text-center">
                            <h3 class="text-uppercase">Move To Arm</h3>
                        </div>
                    </div>
                ...
                <div class="card-footer mt-5">
                    <button class="btn btn-danger" @click="AssignArms">
                        submit
                    </button>
                </div>
            </div>
...
export default {
    ...
    methods: {
        ...
        loadStudents() {
            axios
                .get("/api/getnew_students/" + this.$route.params.id)
                .then((res) => {
        ...
        loadStudentsByArm() {
            ...
            this.form
                .get(
                    `/api/promoted_arms/${this.form.level_id}/${this.form.arm_id}`
                )
                .then((data) => {
        ...
        AssignArms() {
            ...
            this.form.post("/api/assign_arm").then((res) => {
                toast.fire({
                    type: "success",
