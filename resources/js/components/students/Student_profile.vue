                        ...
                        <ul class="nav nav-pills">
                            ...
                            <li class="nav-item">
                                <a
                                    ...
                                    href="#photo-card"
                                    data-toggle="tab"
                                    ><i class="fa fa-address-card mx-1"></i>
                                    PHOTO CARD</a
                                >
                            </li>
                            <li class="nav-item">
                                <a
                                    ...
                                    data-toggle="tab"
                                >
                                    <i class="fa fa-money-bill-alt"></i>FEE
                                    DETAILS</a
                                >
                            </li>
                            <li class="nav-item">
                                ...
                                >
                                    <i class="fa fa-book-open"></i> ASSIGNMENT
                                    AND NOTES</a
                                >
                            </li>
                    ...
                    <div class="card-body">
                        <div class="tab-content">
                            ...
                            <div class="container tab-pane" id="photo-card">
                                ...
                                >
                                    <div
                                        class="card-body row col-md-12 pt-1 mt-0"
                                    >
                                        <div class="col-md-2">
                                            <img
                                    ...
                                    <div class="row container">
                                        ...
                                        <div class="col-md-12 row py-1">
                                            ...
                                            <div class="col-md-6">
                                                <ul
                                                    class="list-group list-group-unbordered mb-3 text-uppercase"
                                                >
                                                    <li class="list-group-item">
                                                        <b>Surname</b>
                                                        <a class="float-right"
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                >
                                                    ...
                                                    <li class="list-group-item">
                                                        <b>Email Address</b>
                                                        <a
                                                            class="float-right text-lowercase"
                                                            >{{
                                                                form.users.email
                                                            }}</a
                                                        >
