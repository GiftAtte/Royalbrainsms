        ...
        >
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form
                        @submit.prevent="editmode ? updateArm() : createArm()"
                    >
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                <input
                                    type="text"
                                    name="nike_name"
                                    placeholder="Enter Nike-name(optional)"
                                    class="form-control"
...
export default {
    ...
    methods: {
        getResults(page = 1) {
            axios.get("api/arm?page=" + page).then((response) => {
