                  ...
                  <tr v-for="level in levels.data" :key="level.id">
                    ...
                    <td class="row">
                     <a href="#" @click="addArm(level.id)" >
                        ...
                        /
                        <a href="#" @click="editModal(level)" class="pl-2">
                            <i class="fa fa-edit blue"></i>
                        </a>
                        /
                        <a href="#" @click="deleteLevel(level.id)" class="pl-2">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Add Arms</h5>
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                ...
                <div class="form-group">
                        <input v-model="form.level_name" type="text" name="level_name"
                            ...
                            class="form-control" :class="{ 'is-invalid': form.errors.has('level_name') }">
