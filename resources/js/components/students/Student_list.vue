        ...
        <div class="content col-md-12" v-if="$gate.isTutorOrAdmin()">
            ...
            <div class="card card-navy card-outline ">
              <div class="card-header">
               ...
               <router-link to="/import_students" class="p-5"> Import student list (cvs)</router-link>
                </div>

                <div class="card-tools">

               <button class="btn btn-success " @click="newModal">Add New <i class="fas fa-user-plus fa-fw"></i></button>
               <button v-show="$gate.isAdmin()" class="btn btn-danger " @click="updatePassword">Update Password <i class="fa fa-pencil fa-fw"></i></button>
                </div>
                 </div>
              </div>
              <!-- /.card-header -->
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                ...
                <div class="form-group">
                    ...
                    <div class="form-group">
                     ...
                     <div class="form-group">
                        <select name="type" v-model="form.gender" id="class_id" class="form-control" :class="{ 'is-invalid': form.errors.has('gender') }">
                        ...
                        // Send request to the server
                         if (result.value) {
                             this.deleteForm.studentIds=this.studentIds
                                this.deleteForm.delete('api/students').
                                then(()=>{
                                        swal.fire(
                                        'Deleted!',
