    ...
    <div>
        <div class="content-header">
            <div class="container-fluid navy">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark">Bill</h1>
                    </div>
                    <!-- /.col -->
                    <div class="col-sm-6">
    ...
    methods: {
        ...
        billAccounts(bill) {
            ...
            if (this.$gate.isAdmin()) {
                this.form.fill(bill);
                this.form.post("/api/billAccounts").then((res) => {
                    //  console.log(res.data)
                    swal.fire(
                        "success!",
                        "Bill has been dispatche successfully.",
                        "success"
                    );
                });
                this.$Progress.finish();
        ...
        getAmount() {
            axios
                .get("/api/getBillAmount/" + this.form.feegroup_id)
                .then((res) => {
