            ...
            <table class="table table-hover" id="data_tb">
              <tbody>
                <tr>
                  ...
                  <th>Class/Level</th>
                  <th>Action</th>
                  <th v-show="$gate.isAdminOrTutor()">Modify</th>
                </tr>
                ...
                <tr v-for="report in reports.data" :key="report.id">
                  ...
                  <td style="display: flex; flex-direction: row">
                    ...
                    >
                      <i class="fa fa-download" title="Go To Downloads"></i>
                    </a>
                    <button
                  ...
                  <td class="row" v-show="$gate.isStudentOrParent()">
                    <p v-if="report.is_ready > 0">
                      ...
                      <router-link
                        ...
                        tag="a"
                        exact
                        ><i class="fa fa-eye"></i> &nbsp;View Reult</router-link
                      >
                    </p>
                    <button
                      v-else
                    ...
                    >
                      <i class="fa fa-eye"></i> &nbsp; Not ready
                    </button>
                    <button
                      @click="showActivationModal(report.id)"
                      v-show="!report.activation_status"
        ...
        <div class="modal-content">
          ...
          <form @submit.prevent="editmode ? updateReport() : CreateReport()">
            <div class="modal-body">
                <div class="container text-warning" v-if="!editmode">
                    <select-input
                    :form="form"
                    :field="cloneId"
                    label="CLONE REPORT CONFIGURATION ?"
                    ...
                    optionValue="id"
                    optionLabel="title"
                    placeholder="Select Report to clone"
                    v-model="form.cloneId"
                  />
                </div>
              ...
              <div class="row">
                ...
                <input-field
                  v-if="form.isMidterm"
                  v-model="form.scoreBase"
                  type="number"
                  name="title"
                  max="100"
                  label="Mid-term Score Base"
                  :form="form"
                />
              </div>
            </div>
        ...
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="example">
              {{ isMaster ? "View Master Sheet" : "computeSummary" }}
            </h5>
            <button
              type="button"
              class="close"
            ...
            <div class="modal-body">
              <div class="form-group">
                <input
                  ...
                  :class="{
                    'is-invalid': activationForm.errors.has('activation_key'),
                  }"
...
export default {
  ...
  methods: {
    ...
    viewMaster() {
      ...
      cloneReport() {
          let report = this.reports.data.find((item) => item.id == this.form.cloneId);
                     console.log(report)
