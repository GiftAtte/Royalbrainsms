...
<p v-if="report.is_ready > 0">
                                        ...
                                        <router-link
                                            ...
                                            "
                                            :to="
                                                `/result/${report.id}/${isStudent}/annual`
                                            "
                                            tag="a"
                                            exact
                        ...
                        <div class="modal-body">
                               ...
                               <div class="form-group">
                                ...
                                >
                                    <option value="" selected
                                        >Select Result Template</option
                                    >
                                    <option value="default-result"
                                        >Default-Terminal</option
                                    >
                                    <option value="default-midterm"
                                        >Default Midterm</option
                                    >
                                    <option value="creche"
                                        >Default Creche Comment</option
                                    >
                                    <option value="mid_term" selected
                                        >Mid-Term Report</option
                                    >
                                    <option value="terminal"
                                        >Madonna Termial</option
                                    >
                                    <option value="mock"
                                        >Mock Exam Report</option
                                    >
                                    <option value="annual">
                                        Madonna Annual Report</option
                                    >
                                    <option value="primary-midterm"
                                        >Madonna Primary Mid-Term</option
                                    >
                                    <option value="primary-terminal">
                                        Madonna Primary Terminal</option
                                    >
                                     <option value="diamond">
                                        DIAMOND SHEET</option
                                    >
                                </select>
                            ...
                            <div class="form-group">
                                <select
                                    ...
                                    id="term_id"
                                    :class="{
                                        'is-invalid': form.errors.has('term_id')
                                    }"
                                    class="form-control"
                                ...
                                >
                                    ...
                                    >
                                    <option value="1">Use Cummulative</option>
                                    <option value="0"
                            ...
                            <div class="form-group">
                                <input
                                    ...
                                    class="form-control"
                                    :class="{
                                        'is-invalid': form.errors.has('header')
                                    }"
                                />
                                <has-error
                                    :form="form"
...
<div class="form-group col-md-3">
        ...
        >
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="example">{{isMaster?'View Master Sheet':'computeSummary'}}</h5>
                        <button
                            type="button"
                            class="close"
                            data-dismiss="modal"
                    ...
                    <form @submit.prevent="isMaster?viewMaster():computeSummary()">
                        <div class="modal-body">
                            <div class="form-group">
                                <select
                                    name="level_id"
                        ...
                        <div class="modal-body">
                            <div class="form-group">
                                <input
                                    ...
                                    :class="{
                                        'is-invalid': activationForm.errors.has(
                                            'activation_key'
                                        )
                                    }"
...
export default {
    ...
    methods: {
      ...
      // const  report=   this.reports.data.find(element=>element.id===id);
        ...
        viewMaster(){
            $("#summaryModal").modal("hide");
           this.$router.push(`/master/${this.report_id}/${this.computeForm.arm_id?this.computeForm.arm_id:''}`)
           this.isMaster=false
        }
    },
    created() {
