            ...
            <div class="content col-md-12">
                <div class="card card-navy card-outline">
                    <div class="card-header">
                        <h5
                            class="header text-danger text-uppercase float-left"
                        >
                    ...
                    >
                        ...
                        <div class="col col-md-12 py-2">
                            <div class="row col-md-10">
                                <div class="col-md-6 py-2">
                                    ...
                                    <h5>
                                        <b>Position:</b>&nbsp;
                                        {{ summary.annual_position }}&nbsp;out
                                        of&nbsp;<b>
                                            {{
                                                summary.totalstudents_overall
                                                    ? summary.totalstudents_overall
                                                    : ""
                                            }}</b
                                        >
                        ...
                        <div class="table-responsive py-2">
                            <table
                                class="table table-bordered text-capitalize table-sm"
                            >
                                <thead>
...
<td v-show="isASLScore">{{score.arm_min_score}}</td> -->
                            ...
                            <div
                                class="text-center text-bold text-primary container"
                            >
                                RESULTS SUMMARY
                            </div>
                            <hr class="text-bold" />
                            ...
                            <div class="col-md-3">
                                ...
                                >
                                    <tr>
                                        <th
                                            colspan="2"
                                            class="text-uppercase text-center text-primary text-bold"
                                        >
                                            PART B-AFFECTIVE
                                        </th>
                                    </tr>
