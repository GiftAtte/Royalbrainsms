...
<div class="col-md-6">
    <table class="table table-bordered table-sm  table-striped text-bold" >
<tr >
...
<div v-show="isTComment" class=" row col-6 "><span><b>General Comment:&nbsp;</b >{{staff_comment?staff_comment:''}}</span></div>
