...
<!--
<first-second-term  v-if="report.type==='mid_term'></first-second-term> -->
...
<div class="card-header">
    ...
    <button v-show="$gate.isTutorOrAdmin()" class="btn btn-primary float-right pl-2" @click="printResults"><i class="fa fa-print"></i>Print Result</button>

    </div>
<div class="card-body pt-0" id="section-to-print"  ref="generatePDF" :style="`background-image: linear-gradient(to bottom, rgba(255,255,255,0.97) 100%,rgba(255,255,255,0.97) 100%), url(/img/schools/${school.logo}) ;background-repeat: no-repeat; background-position: center;background-size: 80%;`">
...
<h5>{{school.contact_address}},<br> {{school.state}}</h5>
...
<center>
<img :src="`/img/profile/${user.photo}`" class="img-thumbnail img-result " width="100" height="50" onerror="this.style.display='none'">
</center>
</div>
</div>
...
<h5><b>Gender:&nbsp;</b> {{summary.student.gender}} </h5>
<h5 ><b>Dob:</b>&nbsp; {{summary.student.dob}}</h5>
...
<h5 ><b>Next Term Begins:&nbsp;</b> {{report.next_term?report.next_term:''}}</h5>
...
<table class="table table-bordered myTable   text-nowrap">
<thead>
<tr>
<th>S/N</th>
<th>Subject</th>
...
<th class="text-center" v-show="isASAScore"><div><span>Subject Average <br> Score</span></div></th>
...
<div class=" col-md-4 ">
<table class="table table-bordered table-sm myTable table-striped" width="100%" >
 <tr >
...
<center>
<div class=" text-center"><span><b>Signature:&nbsp;</b ><img :src="`/img/signatures/${signature?signature.photo:'signature.png'}`" class="ml-2 img-result " width="100" height="50" onerror="this.style.display='none'"></span></div>
</center>
</div>
