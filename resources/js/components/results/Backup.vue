        ...
        <div class="card card-navy card-outline">
            <div class="card-header">
                <div class="ribbon-wrapper">
                    <div class="ribbon bg-primary">Backup</div>
                </div>
                <loading
                ...
                >
                    <i class="fa fa-plus-circle mx-1"></i>Load Session
                </button>
            </div>
            <div class="card-body">
                <div class="row">
...
export default {
    ...
    methods: {
        ...
        loadStudents() {
            ...
            axios
                .get(
                    `api/load_students/${this.report_id}/${this.form.subject_id}`
                )
                .then((result) => {
        ...
        loadSubjects() {
            ...
            if (this.$gate.isAdminOrTutor()) {
                ...
                this.$Progress.start();
                axios
                    .get("api/load_list/" + this.form.report_id)
                    .then((res) => {
        ...
        downloadScores() {
            axios
                .get(`/api/backup/${this.report_id}/${this.subject_id}`)
                .then((res) => {
