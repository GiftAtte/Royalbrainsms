        ...
        <form @submit.prevent="createActivation">
          <div class="card-header">
            <div class="ribbon-wrapper">
              <div class="ribbon bg-primary">Progress</div>
            </div>
          </div>
              ...
              <table class="table table-hover table-sm table-bordered">
                <thead>
                  <tr>
                    <th>S/N</th>
                    <th>Name</th>
                    <th>Cummulative Average Scores</th>
                    <th>Progress Status</th>
                  </tr>
                </thead>
                <tbody>
                  <tr
                    v-for="(activation, index) in Activation_status"
                    :key="index"
                  >
                    <td>{{ index + 1 }}</td>
                    <td>
                    ...
                    <td>
                      {{
                        activation.average_score ? activation.average_score : ""
                      }}
                    </td>
                    <td>
                      <input
...
export default {
  ...
  methods: {
    ...
    loadActivation() {
      this.$Progress.start();
      axios
        .get(`/api/load_results/${this.form.report_id}/${this.form.arm_id}`)
        .then((result) => {
