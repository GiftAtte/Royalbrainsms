          ...
          <div class="col col-12 py-2">
            <div class="row col-md-10">
              <div class="col-md-6 py-2">
                <h5>
                  <b>Name:</b>&nbsp; {{ summary.student.surname }}&nbsp;
                  {{ summary.student.first_name }} &nbsp;
                  {{
              ...
              <div class="col-md-6">
                ...
                <h5>
                  ...
                  {{ report.next_term ? report.next_term : "---------" }}
                </h5>
              </div>
            </div>
          </div>
                  ...
                  <thead>
                    <tr class="text-center">
                      ...
                      <th v-if="!report.isCa2">
                        CA<br />{{
                          report.ca1Percent ? `[${report.ca1Percent}]` : ""
                        }}
                      </th>
                      <th v-if="report.isCa2">
                        1st CA <br />{{
                      ...
                      <th v-if="report.isCa2">
                        2nd CA <br />{{
                          report.ca2Percent ? `[${report.ca2Percent}]` : ""
                        }}
                      </th>

                      <th>
                        Exams <br />{{
                          report.examPercent ? `[${report.examPercent}]` : ""
                        }}
                      </th>
                      <th>TOTAL</th>
                      <th>GRADE</th>
