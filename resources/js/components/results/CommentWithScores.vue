...
<th>S/N</th>
<th>COGNITIVE SKILLS<br/>SUBJECTS</th>
<th>CA</th>
<th>EXAMS</th>
<th>TOTAL</th>
<th>GRADE</th>
...
<tr>
<th colspan="3" class="text-center text-primary text-uppercase table-sm" >SCORE GRADING</th>
</tr>
...
<div v-if="report.isPrincipalComment" class=" row col-6"><span><b>Principal's/Head Teacher's Comment:&nbsp;</b>{{principal_comment?principal_comment:''}}</span></div>
