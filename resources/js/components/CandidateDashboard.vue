    ...
    <section class="section-features">
        ...
        <div class="row">
            <div class="col-md-3 col-sm-12">
                ...
                >
                    <i class="feature-box__icon warning fa fa-book"></i>
                    <h3 class="header-tertiary" style="color: orange">
                        BIO-DATA
                    </h3>
                    <p>Personal Info</p>
                </div>
            ...
            <div class="col-md-3 col-sm-12" @click="navigate('/exams')">
                <div class="feature-box container">
                    ...
                    <h3 class="text-primary u-margin-bottom-small">
                        ADMISSION REQ.
                    </h3>
            ...
            <div class="col-md-3 col-sm-12">
                ...
                >
                    <i
                        class="feature-box__icon success fas fa-money-bill-alt"
                    ></i>
                    <h3 class="text-success u-margin-bottom-small">CBT</h3>
                    <p>Online Exams/Result</p>
                </div>
            </div>
            ...
            <div class="col-md-3 col-sm-12">
                ...
                >
                    ...
                    <h3 class="text-danger u-margin-bottom-small">
                        ADMISSION STATUS
                    </h3>
                    <p>Check admission Status</p>
                </div>
            </div>
        </div>
    </section>
...
export default {
    ...
    created() {
        axios.get("/api/personalInfo/").then((res) => {
            if (!res.data) {
                this.navigate("/admission/profile");
            }
        });
    },
};
