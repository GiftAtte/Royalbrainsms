...
<div class="content-header">
      ...
      <div class="container-fluid navy" >
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Subdomains</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
          ...
          <div class="col-12">
            <div class="card card-navy card-outline">
              <div class="card-header">
                  <h3 class="card-title text-danger">{{domainName}} Subdomains</h3>
                ...
                <table class="table table-hover">
                  ...
                  <tr v-for="domain in domains" :key="domain.id">
                    ...
                    <td>{{domain.name|upText}}</td>
                     <td>{{domain.domains?domain.domains.name:''}}</td>
              ...
              <div class="card-footer">
                <router-link :to="`/creche_domain`" tag="button" class=" btn btn-success pl-2">
                        GO TO DOMAINS
                        </router-link>
              </div>
            </div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
                    <h5 class="modal-title" v-show="!editmode" id="addNewLabel">Add New {{domainName}} Subdomains</h5>
                ...
                swal.fire({
                    ...
                    confirmButtonText: 'Yes, delete it!'
                        ...
                        // Send request to the server
                         if (result.value) {
                                this.form.delete('/api/subdomains/'+id).
                                then(()=>{
                                        swal.fire(
                                        'Deleted!',
